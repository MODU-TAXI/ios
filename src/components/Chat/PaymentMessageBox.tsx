...
interface PaymentMessageBoxComponentProps {
  message: ChatMessage;
  toPaymentScreen: () => void;
}

const PaymentMessageBoxComponent: React.FC<PaymentMessageBoxComponentProps> = ({
  message,
  toPaymentScreen,
}) => {
...
export default PaymentMessageBoxComponent;
